...
type HostIPCEnabled struct {
	rules.RuleInfo
}

func (h HostIPCEnabled) Info() rules.RuleInfo {
	return h.RuleInfo
}

func NewHostIPCEnabled(rule rules.RuleInfo) HostIPCEnabled {
	return HostIPCEnabled{
		RuleInfo: rule,
	}
}

func (h HostIPCEnabled) Recommendation() string {
...
func (h HostIPCEnabled) Check(client *kubernetes.Clientset) ([]rules.Finding, error) {
